...
module lab04 (
  ...
  assign opcode_temp = s14[31:26];
  assign src1_addr_temp = s14[25:21];
  assign src2_addr_temp = s14[20:16];
  assign s4 = s14[15:11];
  assign s2 = s14[15:0];
  assign Alures = s8[7:0];
  // control_unit
